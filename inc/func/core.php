...
//PANPAN DELETE
//            $navemenu[5] = array(
//                'title' => '<a href="index.php?c=site&a=entry&op=display&do=inuser&m=zh_cjdianc" class="panel-title wytitle" id="yframe-5"><icon style="color:#8d8d8d;" class="fa fa-user"></icon>  会员管理２２２</a>',
//                'items' => array(
//                    0 => $this->createMainMenu('会员管理BBB ', $do, 'inuser', ''),
//
//                )
//            );
            $navemenu[9] = array(
    ...
    public function getNaveMenu($storeid, $action, $uid = '')
    {
        ...
        if ($account['role'] == 1) {
            ...
            $navemenu[2] = array(
             ...
             $navemenu[5] = array(
                        'title' => '<a href="cjdianc.php?c=site&a=entry&op=display&do=dlinuser&m=zh_cjdianc" class="panel-title wytitle" id="yframe-5"><icon style="color:#8d8d8d;" class="fa fa-user"></icon>会员管理CCC</a>',
                        'items' => array(
